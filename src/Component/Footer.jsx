...
function Footer() {
  ...
  return (
    <>
            <div className=' w-full h-auto bg-[#27272A] text-white sm:flex p-8'>
            ...
            <div className=' w-full h-auto py-3 bg-[#27272A] text-white text-xs text-nowrap flex flex-col items-center sm:text-[15px]'>
                        <p>&copy; 2024 AceGrade || All rights reserved.</p>
            </div>
